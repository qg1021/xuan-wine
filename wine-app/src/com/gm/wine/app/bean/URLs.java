...
public class URLs implements Serializable {
	...
	public final static String HOST = "www.crafts-bamboo.com/wine";// www.crafts-bamboo.com/wine
	...
	public final static String NOTICE_PUB = URL_API_HOST + "notice!save.action";// 发布留言
